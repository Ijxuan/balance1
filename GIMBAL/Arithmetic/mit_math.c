...
float angle_qhq_R = 0;	// 前后倾斜的角度
float angle_qhq_pi_R = 0; // 前后倾斜的角度 弧度制

float angle_qhq_L = 0;	// 前后倾斜的角度
float angle_qhq_pi_L = 0; // 前后倾斜的角度 弧度制
...
//			keep_BALENCE_by_MIT_THETA_to_X=0;/*时候开启改变摆杆角度保持机体平衡的功能*/
...
void update_gyro()
{
	...
	{
		cumulate_angle_change = angle_qhq_pi_R - pitch_angle_last_time;	// 角度变化量
