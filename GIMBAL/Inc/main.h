...
extern int flash_read_times;//flash¶ÁÈ¡ÀÛ¼Æ¼ÆÊ±

extern bool send_to_C;
extern int send_to_C_times;//dr16·¢ËÍ´ÎÊı
extern bool open_CHASSIS_follow;//¿ªÆôµ×ÅÌ¸úËæÔÆÌ¨Õâ¸ö¹¦ÄÜ
extern int CHASSIS_follow_times;//µ×ÅÌ¸úËæÔÆÌ¨Ê±¼ä


extern bool send_to_C_JS_SHOOT;
extern bool send_to_C_JS_HURT;//²ÃÅĞÏµÍ³_ÉËº¦Êı¾İ_ÊÇ·ñ·¢ËÍ¸øC°å
extern bool send_to_C_JS_STATUS;//²ÃÅĞÏµÍ³_×´Ì¬Êı¾İ_ÊÇ·ñ·¢ËÍ¸øC°å
extern bool send_to_C_JS_HEAT;//²ÃÅĞÏµÍ³_ÈÈÁ¿Êı¾İ_ÊÇ·ñ·¢ËÍ¸øC°å

extern int JS_SEND_times;//²ÃÅĞÏµÍ³·¢ËÍ´ÎÊı
extern int send_to_C_STATUS_times;//ÒòÎª×´Ì¬Êı¾İ·Ö4¶Î·¢ËÍ,ËùÒÔ¼ÆÊı±£ÏÕÒ»µã
extern int JS_RC_times;//²ÃÅĞÏµÍ³½ÓÊÕ´ÎÊı
