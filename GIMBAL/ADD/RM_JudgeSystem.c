...
void Ex_CrossHair(void)
{
	...
	Ex_ShowData.cilentData[3].start_x = 945; //原 860
	Ex_ShowData.cilentData[3].start_y = 280; //原：560
	Ex_ShowData.cilentData[3].radius = 0;
	Ex_ShowData.cilentData[3].end_x = 975; //原1060
...
void LEDYellow_Mean(void)
{
	...
	Led_Meaning.cilentData.grapic_data_struct.end_angle = 10; //需要按照自己显示的字符长度修改
...
void LEDGreen_Mean(void)
{
	...
	Led_Meaning.cilentData.grapic_data_struct.start_angle = 20;
	Led_Meaning.cilentData.grapic_data_struct.end_angle = 10; //同一10
	Led_Meaning.cilentData.grapic_data_struct.width = 3;
